...
def declaracionDFA():   
    dfaDb = DFA(
        ...
        transitions = {
            ...
            'q29': {' ': 'q29', '"': 'q73', "'": 'q73'},  
            'q30': {' ': 'q30', '"': 'q31', "'": 'q31'},  
            'q31': dict({'.': 'q31', '"': 'q32', "'": 'q32','0': 'q31','1': 'q31','2': 'q31','3': 'q31','4': 'q31','5': 'q31','6': 'q31','7': 'q31','8': 'q31','9': 'q31'},**createDict(alphabet, 'q31')),   
            'q32': {'}': 'q70', ',': 'q22', ' ': 'q32'},  
            'q33': {'A': 'q34'},  
            'q34': {'M': 'q35'},  
            'q35': {'E': 'q36'},  
            ...
            'q42': {' ': 'q42', '"': 'q75', "'": 'q75'},  
            'q43': {' ': 'q43', '"': 'q44', "'": 'q44'},  
            'q44': dict({'"': 'q32', "'": 'q32'},**createDict(symbols[2:len(symbols)+1]+alphabet, 'q44')), 
            'q45': {'A': 'q46', 'O': 'q55'}, 
            'q46': {'S': 'q47'},
            'q47': {'S': 'q48'},
            'q48': {'W': 'q49'},
            ...
            'q52': {'"': 'q76', "'": 'q76',' ': 'q52'},
            'q53': {' ': 'q53', '"': 'q54', "'": 'q54'},
            'q54': dict({"'": 'q32', '"': 'q32'}, **createDict(symbols[2:len(symbols)+1]+alphabet, 'q54')),
            'q55': {'R': 'q56'},
            'q56': {'T': 'q57'},
            'q57': {' ': 'q57', '"': 'q77', "'": 'q77'},
            'q58': {'"': 'q59', "'": 'q59', ' ': 'q58'},
            ...
            'q66': dict({'.': 'q67', '"': 'q32', "'": 'q32'},**createDict(alphabet,'q66')),
